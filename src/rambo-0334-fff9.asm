...
; $4000. Screen RAM
        * = $4000
        ...
        .BYTE $20,$20,$20,$20
        .BYTE $A8
        .BYTE $A9,$B8,$B9,$AC,$AD,$A8,$A9,$A8
        .BYTE $A9,$48,$49,$78,$79,$4C,$4D,$60
        .BYTE $61,$74,$75
        .BYTE $58,$59,$A8,$A9,$A8,$A9,$A8,$A9
        .BYTE $B4,$B5,$D4,$D5,$B4,$B5,$B4,$B5
        .BYTE $B4,$B5,$B4,$B5
        .BYTE $AA
        .BYTE $AB,$BA,$BB,$AE,$AF,$AA,$AB,$AA
        .BYTE $AB,$4A,$4B,$7A,$7B,$4E,$4F,$62
        .BYTE $63,$76,$77
        .BYTE $5A,$5B,$AA,$AB,$AA,$AB,$AA,$AB
        ...
        .BYTE $20,$20,$20,$20
        .BYTE $A8
        .BYTE $A9,$BC,$BD,$AC,$AD,$A8,$A9,$A8
        .BYTE $A9,$A8,$A9,$A8,$A9,$44,$45,$A0
        .BYTE $A1,$A8,$A9
        .BYTE $A8,$A9,$A8,$A9,$A8,$A9,$A8,$A9
        .BYTE $B4,$B5,$D0,$D1,$D8,$D9,$B4,$B5
        .BYTE $B4,$B5,$B4,$B5
        .BYTE $AA
        .BYTE $AB,$BE,$BF,$AE,$AF,$AA,$AB,$AA
        .BYTE $AB,$AA,$AB,$AA,$AB,$46,$47,$A2
        .BYTE $A3,$AA,$AB
        .BYTE $AA,$AB,$AA,$AB,$AA,$AB,$AA,$AB
        ...
        .BYTE $20,$20,$20,$20
        .BYTE $A8
        .BYTE $A9,$C0,$C1,$AC,$AD,$B0,$B1,$B0
        .BYTE $B1,$B0,$B1,$8C,$8D,$78,$79,$74
        .BYTE $75,$A0,$A1
        .BYTE $B0,$B1,$B0,$B1,$B0,$B1,$A8,$A9
        .BYTE $B4,$B5,$D0,$D1,$D4,$D5,$B4,$B5
        .BYTE $B4,$B5,$B4,$B5
        .BYTE $AA
        .BYTE $AB,$C2,$C3,$AE,$AF,$B2,$B3,$B2
        .BYTE $B3,$B2,$B3,$8E,$8F,$7A,$7B,$76
        .BYTE $77,$A2,$A3
        .BYTE $B2,$B3,$B2,$B3,$B2,$B3,$AA,$AB
